---
name: researcher
description: Search local files and web resources to find relevant information, documentation, patterns, and answers. Provide comprehensive, concise research findings with file references and citations.
