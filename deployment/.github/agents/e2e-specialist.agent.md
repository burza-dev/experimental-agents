---
name: e2e-specialist
description: Implement Playwright end-to-end tests in pytest with functional coverage plus screenshot capture (and optional visual snapshot gating). Configure artifacts (screenshots/traces/videos) and report locations and commands.
tools: ["codebase", "search", "terminal", "editFiles", "problems", "useBrowser", "fetch"]
