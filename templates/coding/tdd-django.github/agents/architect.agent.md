---
name: architect
description: Create acceptance criteria and test-first plan for async Python 3.13+/Django ASGI/pytest/Playwright/Docker. Focus on endpoints, edge cases, and async hazards.
...
## Coverage Goal
- 75% line and branch (project requirement)
```
