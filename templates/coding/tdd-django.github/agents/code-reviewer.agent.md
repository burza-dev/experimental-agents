---
name: code-reviewer
description: Review implementation quality, architecture, and modern dependency usage. Provide precise issue descriptions with file+symbol references. No diffs.
