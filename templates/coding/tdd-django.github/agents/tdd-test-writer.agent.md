...
description: Write failing tests BEFORE implementation (TDD Red phase). Translate acceptance criteria into executable test cases. Tests must fail initially.
...
- `.github/skills/typer-cli-testing/SKILL.md` - Typer CLI command testing with CliRunner
...
### 1. Acceptance criteria as tests
```python
# Given: [precondition]
# When: [action]
